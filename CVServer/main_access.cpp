...
int main(int argc, char** argv)
{
    ...
    float matched_ratio_threshold = atof(argv[3]); // 0.3; // Above this value, consider it as a match
    ...
    for ( ; !success ; ) {
        try {
            ...
            */
            ...
            // Do the following steps only if there's an object matched
            ...
            // Also only do this when there's an object matched
            ...
            */
            ...
            if (announcing_state || feedback.find("press it") != string::npos) {
                sleep(1); // 1 second
            }
